---
title: "COMP 9690 - 090 Programming for BioMedical Data"
...
The 4 short courses that you need to complete are:
...
You should complete these courses **sequentially**, starting with *Introduction to R for Data Analysis*, and ending with *Statistics with R*. 

You should complete each course by the due date listed above. Each course has several graded projects that must be completed to complete the course.
...
**Late policy**: If you do not complete a course by its due date (see above) ????????


## Contact

Please email Jeff Phillips (jeff.m.phillips@utah.edu) and Rebecca Barter (rebecca.barter@hsc.utah.edu) with any questions or for more information.
